        ...
        <SlideUp delay={2}>
            <div className="bg-background rounded-[10px] flex flex-col items-start gap-5 shadow-4xl h-full">
                <div className="w-full">
                    <Image src={thumb} width={630} height={271} sizes="100vw" alt="blog-img-3" className="w-full" />
                </div>
                <div className="px-10 pb-10">
                    ...
                    <h3 ><Link href="/blog-details" className="md:text-2xl text-xl md:leading-[141%] leading-[120%] font-semibold hover:text-secondary-foreground transition-all duration-500">{title}</Link></h3>
