    ...
    <div className="xl:block hidden">
      ...
      >
        <div className="flex justify-between items-center">
          <Logo />
          <div
            className="bg-primary w-10 h-10 text-cream-foreground flex items-center justify-center rounded-[4px] left-4 cursor-pointer "
            onClick={() => setActive(false)}
          >
        ...
        <div className="mt-6">
          <p>
            Its. sit amet, consectetur adipisicing elit. A rerum sit
            odit illo ducimus libero, fugiat saepe beatae ut quasi
            provident necessitatibus esse porro eligendi illum facilis
            quia.
          </p>
        </div>
