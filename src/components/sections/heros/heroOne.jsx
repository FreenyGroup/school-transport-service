    ...
    <section className="bg-warm pt-[78px] lg:mb-15 mb-10 relative">
      <div className="container relative">
        <div className="flex flex-col items-center text-center relative z-10">
          <Title
            size={'7.5xl'}
            className={'font-normal max-w-[776px]'}
          >
            ...
            <span className="font-bold"> at the Wheel of</span>{' '}
          ...
          <p className="pt-5 max-w-[431px]">
            On time. Safe. Reliable. School Transport Services leads
            the way in supplemental student transportation, getting
            students where they need to be — safely and dependably.
          </p>
        </div>
        <div className="absolute left-2.5 lg:top-0 top-10 lg:max-w-full max-w-[200px] sm:block hidden animate-up-down">
          <Image
            src={'/images/banner/boy_img_1.png'}
            width={250}
            height={356}
            alt="banner-img-1"
          />
        ...
        <div className="absolute right-0 bottom-0 pb-[71px] lg:block hidden animate-up-down">
          <Image
            src={'/images/banner/boy_img_2.png'}
            width={285}
            height={369}
            alt="banner-img-2"
          />
